...
st.write("""El acceso equitativo a vacunas   seguras  y eficaces es fundamental para poner fin a la pandemia""")
st.write("""de COVID-19, por lo que es enormemente alentador ver que hay tantas vacunas en fase de prueba. """)
